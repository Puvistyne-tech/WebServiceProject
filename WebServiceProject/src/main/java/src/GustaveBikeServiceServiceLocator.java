...
public class GustaveBikeServiceServiceLocator extends org.apache.axis.client.Service implements src.GustaveBikeServiceService {
    ...
    private java.lang.String GustaveBikeService_address = "http://localhost:8080/WebServiceProject/services/GustaveBikeService";
    ...
    public src.GustaveBikeService_PortType getGustaveBikeService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            src.GustaveBikeServiceSoapBindingStub _stub = new src.GustaveBikeServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (src.GustaveBikeService_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                src.GustaveBikeServiceSoapBindingStub _stub = new src.GustaveBikeServiceSoapBindingStub(new java.net.URL(GustaveBikeService_address), this);
                _stub.setPortName(getGustaveBikeServiceWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://app", "GustaveBikeServiceService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://app", "GustaveBikeService"));
        }
